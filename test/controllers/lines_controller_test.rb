...
class LinesControllerTest < ActionController::TestCase
  ...
  test "should create line" do
    assert_difference('Line.count') do
      post :create, line: { active: @line.active, colour: @line.colour, description: @line.description, name: @line.name, stub: @line.stub }
    end
  ...
  test "should update line" do
    patch :update, id: @line, line: { active: @line.active, colour: @line.colour, description: @line.description, name: @line.name, stub: @line.stub }
    assert_redirected_to line_path(assigns(:line))
  end
