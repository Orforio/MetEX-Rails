...
class LinesControllerTest < ActionController::TestCase
  ...
  test "should create line" do
    assert_difference('Line.count') do
      post :create, line: { active: @line.active, description: @line.description, name: @line.name, slug: @line.slug }
    end
  ...
  test "should update line" do
    patch :update, id: @line, line: { active: @line.active, description: @line.description, name: @line.name, slug: @line.slug }
    assert_redirected_to line_path(assigns(:line))
  end
